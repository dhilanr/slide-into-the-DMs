...
class API(object):
    ...
    def send_direct_message(self, recipient_id, text, quick_reply_type=None, quick_reply_options=None, ctas=None, attachment_type=None, attachment_media_id=None):
        ...
        if ctas is not None:
            json_payload['event']['message_create']['message_data']['ctas'] = ctas
    ...
    def _send_direct_message(self):
        ...
        return bind_api(
            ...
            method='POST',
            payload_type='direct_message',
            allowed_param=['recipient_id', 'text', 'quick_reply_type', 'quick_reply_options', 'ctas', 'attachment_type', 'attachment_media_id'],
            require_auth=True
        )
...
## NEW WELCOME MESSAGE ADDITIONS TO TWEEPY
    @property
    ...
    # Works like adapted send_direct_message(args)
    def new_welcome_message(self, name, text, quick_reply_type=None, quick_reply_options=None, ctas=None, attachment_type=None, attachment_media_id=None):
        """ :reference: https://developer.twitter.com/en/docs/direct-messages/sending-and-receiving/api-reference/new-event
        ...
        if quick_reply_type is not None:
            message_data_object['quick_reply'] = {'type': quick_reply_type, 'options': quick_reply_options}

        if ctas is not None:
            message_data_object['ctas'] = ctas

        if attachment_type is not None and attachment_media_id is not None:
            message_data_object['attachment'] = {'type': attachment_type}
            message_data_object['attachment']['media'] = {'id': attachment_media_id}
        ...
        json_payload = {}
        json_payload.update({'welcome_message':welcome_message})

        return self._send_welcome_message(json_payload=json_payload)
        # return bind_api(
        #     api=self,
